...
| `2026-09-21-low-scores.sql` | Allowed scores under 70, stored as 45 for "Not recommended". The app now offers only that one grade below 70; anything under 70 is rated but out of every roll |
